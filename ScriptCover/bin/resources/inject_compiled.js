...
brt.backgroundInteraction = {};
brt.backgroundInteraction.objectCounter = 0;
goog.exportSymbol("brt.backgroundInteraction.objectCounter", brt.backgroundInteraction.objectCounter);
window.scriptObjects = [];
goog.exportSymbol("window.scriptObjects", window.scriptObjects);
...
brt.backgroundInteraction.submitCoverageInfo = function() {
  ...
  if(coverageContainerDiv) {
    coverageContainerDiv.innerHTML = goog.json.serialize(data), brt.backgroundInteraction.fireEvent_(brt.constants.EventType.SUBMIT_COVERAGE_INFO)
  }
};
goog.exportSymbol("brt.backgroundInteraction.submitCoverageInfo", brt.backgroundInteraction.submitCoverageInfo);
...
goog.exportSymbol("brt.backgroundInteraction.showCoverage", brt.backgroundInteraction.showCoverage);
brt.backgroundInteraction.setBeforeUnloadHandler = function() {
  goog.events.listen(goog.dom.getDocument(), brt.constants.EventType.BEFORE_UNLOAD, brt.backgroundInteraction.showCoverage, true);
  var coverageContainerDiv = goog.dom.getElement("coverageContainerDiv");
  coverageContainerDiv && goog.events.listen(coverageContainerDiv, brt.constants.EventType.COLLECT_PERIODIC_COVERAGE, brt.backgroundInteraction.showCoverage, true)
};
goog.events.listen(goog.global.document, "click", brt.backgroundInteraction.showCoverage, true);
